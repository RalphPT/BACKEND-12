...
usuarios(nombre = 'Rafael', edad = 27, sexo = 'Masculino', nacionalidad = 'peruano')


usuarios(direccion = 'Las Begonias 113', apellido = 'Juarez', hobbies = ['Jugar videojuegos', 'Nadar', 'Montar bici'])